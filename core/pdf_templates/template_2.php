...
<body>
	<div class="upi_template_editor_wrapper">
		...
		if($upi_order_invoice_settings['is_hidden']!=1){?>
            <div class="upi_template_sections">
                <div class="upi_order_details_wrppar upi_template_section_settings" style="font-size:<?php echo esc_attr($upi_order_invoice_settings['font_size']);?>px;background:<?php echo esc_attr($upi_order_invoice_settings['bg']);?>;">
                    <div class="upi_order_data_wrapper">
                        <div class="upi_order_data upi_order_invoice_title" style="font-size:<?php echo esc_attr($upi_order_invoice_settings['font_size']);?>px;"><?php echo $upi_order_invoice_settings['title'].$invoice_number;?></div>
                        <div class="upi_order_sample_data upi_order_invoice_payment" style="font-size:<?php echo esc_attr($upi_order_invoice_settings['font_size']);?>px;background:<?php echo esc_attr($upi_order_invoice_settings['bg1']);?>">Order ID : #<?php echo esc_html($order_id);?></div>
                    </div>
                </div>
            </div>
        <?php }
            ...
            <div class="upi_template_sections">
                ...
                <div class="upi_template_invoice_from_wrapper upi_template_section_settings">
                    <div class="upi_company_address">
                        <div class="upi_to_address" style=" <?php echo esc_attr('float:'.$upi_to_address_settings['position'].'; text-align: '.$upi_to_address_settings['text_align'].'; font-size: '.$upi_to_address_settings['font_size'].'px;');?>"><?php echo $billing_address;?></div>
                    </div>
									...
									if($is_preview=='1')
									{
										...
										?>
                                         <tr class="upi_product_list_data_wrapper">
                                            ...
                                            <td class="upi_product_list_data"><?php echo esc_html($product_data['item_meta']['_qty']);?></td>
		...
		if($upi_product_history_settings['is_hidden']!=1){?>
            <div class="upi_template_sections upi_order_total_section">
                <div class="upi_order_total_wrapper upi_template_section_settings" style="font-size:<?php echo esc_attr($upi_order_total_settings['font_size']);?>px;background:<?php echo esc_attr($upi_order_total_settings['bg']);?>;">
                    <div class="upi_order_data_wrapper">
                        <div class="upi_order_data upi_order_total_title" style="font-size:<?php echo esc_attr($upi_order_total_settings['font_size']);?>px;"><?php echo $upi_order_total_settings['title'];?></div>
                        <div class="upi_order_sample_data upi_order_total_payment" style="font-size:<?php echo esc_attr($upi_order_total_settings['font_size']);?>px;background:<?php echo esc_attr($upi_order_total_settings['bg1']);?>"><?php echo wc_price($order_data->order_custom_fields['_order_total'][0], array( 'currency' =>$upi_order_currency ) );?></div>
                    </div>
                </div>
            </div>
		<?php }?>
