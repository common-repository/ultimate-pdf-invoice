		...
		<div class="upi_template_sections">
						...
						<div class="upi_section_setting">
							...
							<div class="upi_section_setting_element_wrapper">
                                 ...
                                 <?php
                                 	for($i=8;$i<40;$i++)
									{
									 		echo '<option '.selected($i,$upi_to_address_settings['font_size'],1).' value="'.esc_attr($i).'">'.esc_html($i).' px</option>';
									}
								 ?>
                                </select>
							</div>
			...
			<div class="upi_order_details_wrppar upi_template_section_settings" style="font-size:<?php echo esc_attr($upi_order_invoice_settings['font_size']);?>px;background:<?php echo esc_attr($upi_order_invoice_settings['bg']);?>;">
				...
				<div class="upi_order_data_wrapper">
					...
					<div class="upi_order_sample_data">821</div>
				</div>
				<div class="upi_order_data_wrapper">
					<div class="upi_order_data">Invoice date</div>
					<div class="upi_order_sample_data">2016-01-01</div>
				</div>
				<div class="upi_order_data_wrapper">
					<div class="upi_order_data">Payment Method</div>
					<div class="upi_order_sample_data">Cash On Delivery</div>	
				</div>	
				<div class="upi_logo_settings upi_btn"><i class="dashicons dashicons-admin-generic upi_settings_btn_icon"></i></div>	
				<div class="upi_section_setting_wrapper">
						<div class="upi_section_setting">
							...
							<div class="upi_section_setting_element_wrapper">
								<input type="text" class="upi_setting_input_element" value="<?php echo esc_attr($upi_order_invoice_settings['title']);?>" name="upi_order_invoice_title"  onkeyup="upi_change_element_data(this,'upi_order_invoice_title','content');"/>
							</div>
						</div>
						<div class="upi_section_setting">
							<div class="upi_section_setting_title"><?php _e('Font size',UPI_TEXTDOMAIN);?></div>
							<div class="upi_section_setting_element_wrapper">
                            	 <select name="upi_order_invoice_font_size" class="upi_select_element" onchange="upi_change_css_data(this,'upi_order_details_wrppar','font-size');" >
                                 <?php
                                 	for($i=8;$i<40;$i++)
									{
				...
				<table class="upi_product_list" cellpadding="0" cellspacing="0" style="background:<?php echo $upi_product_history_settings['body_bg'];?>;">
					...
					<tbody>
						...
						<tr class="upi_product_list_data_wrapper">
							...
							<td class="upi_product_list_data">$10</td>
